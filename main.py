...
img = ImageTk.PhotoImage(Image.open("images\sale.jpg").resize((WIDTH, HEIGHT), Image.ANTIALIAS))
...
class LoginApp(tk.Tk):
    def __init__(self):
        ...
        self.MFrame = LabelFrame(self, width=100, height=500, font=('arial', 15, 'bold'), bg='orange', bd=15, relief='ridge')
        self.MFrame.grid(row=1, column=0, padx=200, pady=50)
        self.EFrame = LabelFrame(self, width=100, height=500, font=('arial', 10, 'bold'), bg='orange', relief='ridge', bd=13)
        self.EFrame.grid(row=2, column=0, pady=10)

        self.Lsyslogin = Label(self.MFrame, text='SYSTEM LOGIN:', font=('arial', 15, 'bold'),height=5, bg='orange')
        self.Lsyslogin.grid(row=1, column=0, sticky=W, padx=20)
        self.LUsername = Label(self.MFrame, text='___Username___:', font=('arial', 15, 'bold'), bg='orange')
        self.LUsername.grid(row=2, column=0,sticky=W, padx=20)
        self.Lupass = Label(self.MFrame, text='___Password___:', font=('arial', 15, 'bold'), bg='orange')
        self.Lupass.grid(row=3, column=0, sticky=W, padx=20)


        self.Txtfastname = Entry(self.MFrame, font=('arial', 10, 'bold'),width=35, textvariable=fastname)
        self.Txtfastname.grid(row=2, column=1, padx=30, pady=7,)
        self.Txtupass = Entry(self.MFrame, font=('arial', 10, 'bold'),width=35, show="*", textvariable=password)
        ...
        self.btnlogin = Button(self.EFrame, text='LOGIN',bg='#3f96d9', font=('arial', 10, 'bold'), width=9, command=self.adlogn)
        ...
        self.btnExit = Button(self.EFrame, text='EXIT',bg='#3f96d9', font=('arial', 10, 'bold'), width=9, command=self.exitt)
        ...
        self.btnAbout = Button(self.EFrame, text='ABOUT',bg='#3f96d9', font=('arial', 10, 'bold'), width=9, command=self.clickabout)
        ...
        self.btnReg = Button(self.EFrame, text='REGISTER',bg='#3f96d9', font=('arial', 10, 'bold'), width=9, command=self.clickreg)
    ...
    def adlogn(self):
        ...
        if fastname == "" or password == "":
            ...
            try:
                ...
                cursor = conn.cursor()
                cursor.execute("select * from admin where fastname=%s and password=%s", (fastname, password))
